...
public final class ItemNewsBinding implements ViewBinding {
  ...
  private ItemNewsBinding(@NonNull CardView rootView, @NonNull ImageButton btnStar,
      @NonNull TextView dateTextView, @NonNull ImageView imageView,
      @NonNull TextView locationTextView, @NonNull TextView titleTextView) {
  ...
  public static ItemNewsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemNewsBinding((CardView) rootView, btnStar, dateTextView, imageView,
